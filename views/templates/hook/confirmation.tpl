...
<p>
	...
	<br />- {l s='Reference' mod='paylater'} : <span class="reference"><strong>{$reference|escape:'html':'UTF-8'}</strong></span>
...
{else}
<h3>{l s='Your order on %s has not been accepted.' sprintf=$shop_name mod='paylater'}</h3>
<p>
	<br />- {l s='Reference' mod='paylater'} <span class="reference"> <strong>{$reference|escape:'html':'UTF-8'}</strong></span>
	<br /><br />{l s='Please, try to order again.' mod='paylater'}
	<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='paylater'} <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team.' mod='paylater'}</a>
</p>
{/if}
<hr />